...
labels = [
    ...
    Label(  'solid'                , 35 ,       19 , 'lane line'       , 8       , True         , False        , (119, 66, 32) ),
    Label(  'solid solid'          , 36 ,       19 , 'lane line'       , 8       , True         , False        , (119, 66, 32) ),
    Label(  'dashed dashed'        , 34 ,       19 , 'lane line'       , 8       , True         , False        , (119, 66, 32) ),
    Label(  'dashed-solid'         , 37 ,       19 , 'lane line'       , 8       , True         , False        , (119, 66, 32) ),
    Label(  'solid-dashed'         , 38 ,       19 , 'lane line'       , 8       , True         , False        , (119, 66, 32) ),
    Label(  'yellow dashed'        , 39 ,       19 , 'lane line'       , 8       , True         , False        , (119, 119, 32) ),
    Label(  'yellow solid'         , 40 ,       19 , 'lane line'       , 8       , True         , False        , (119, 119, 32) ),
    Label(  'yellow solid solid'   , 41 ,       19 , 'lane line'       , 8       , True         , False        , (119, 119, 32) ),
    Label(  'yellow dashed dashed' , 42 ,       19 , 'lane line'       , 8       , True         , False        , (119, 119, 32) ),
